...
import { AiOutlineArrowLeft } from "react-icons/ai"; // For the back arrow
...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await ForgotPassword(email); // Your forgotPassword function
    setIsSubmitted(true);
  ...
  return (
    ...
    <div className="relative bg-gradient-to-r from-[#5D54A4] to-[#7C78B8] w-full max-w-[400px] h-[500px] shadow-[0px_0px_24px_#5C5696] overflow-hidden">
      ...
      <h2 className="pt-[80px] pb-[50px] text-center text-[#30008b] text-2xl font-bold">Forget Password</h2>
        {!isSubmitted ? (
